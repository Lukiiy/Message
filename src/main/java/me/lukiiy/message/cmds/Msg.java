...
public class Msg implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] strings) {
        Component defUsage = Message.getInstance().formattedConfigMessage("usage").append(Component.text("/msg <player> <msg>"));
        ...
        if (strings[0].equals("-reload")) {
            ...
            senderAudience.sendMessage(Message.getInstance().formattedConfigMessage("reload"));
            return true;
        }
        ...
        Message.getInstance().message(commandSender, to, String.join(" ", strings).substring(strings[0].length() + 1));
        return true;
    }
}
